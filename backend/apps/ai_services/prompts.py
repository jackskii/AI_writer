...
# =============================================================================
# Auto Describe Entry Prompt
# =============================================================================

AUTO_DESCRIBE_ENTRY_SYSTEM_PROMPT = """你是一位客观的角色记录员。请严格基于我提供的文本资料，提取并整理人物信息。

**指令（请严格遵守）：**
1. 主要从文本资料中提取直接描述信息
2. 如果有"补充说明"，请将其中的信息也纳入描述（补充说明中的内容优先级高于文本资料推断）
3. 完全按照以下格式输出，不添加任何额外文字：
...
1. 保留原描述中仍然正确的信息
2. 根据新资料更新或补充信息
3. 如果有"补充说明"，请将其中的信息也纳入描述（补充说明中的内容优先级最高）
4. 如果新资料与原描述冲突，以新资料为准
5. 完全按照以下格式输出，不添加任何额外文字：
